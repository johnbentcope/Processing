...
void draw() {
  ...
  for (int i = 0; i < haloTurns; i++) {
    for (int j = 0; j < haloPoints; j++) {
      pushMatrix();
      rotateZ(i*TWO_PI/haloTurns + j*TWO_PI/haloPoints/haloTurns - frameCount*PI/120);
      translate(Rd *5, 0, 0);
  ...
  for (int i = 0; i < haloTurns; i++) {
    for (int j = 0; j < haloPoints; j++) {
      pushMatrix();
      rotateZ(i*TWO_PI/haloTurns + j*TWO_PI/haloPoints/haloTurns+PI/6- frameCount*PI/120);
      translate(Rd *5, 0, 0);
      rotateY(j*TWO_PI/haloPoints+frameCount*PI/60f);
      translate(Rd*1.6, 0, 0);
  ...
  for (int i = 0; i < haloTurns; i++) {
    for (int j = 0; j < haloPoints; j++) {
      pushMatrix();
      rotateZ(i*TWO_PI/haloTurns + j*TWO_PI/haloPoints/haloTurns+10*PI/6- frameCount*PI/120);
      translate(Rd *5, 0, 0);
      rotateY(j*TWO_PI/haloPoints+frameCount*PI/60f);
      translate(Rd*1.6, 0, 0);
  ...
  for (int i = 0; i < haloTurns; i++) {
    for (int j = 0; j < haloPoints; j++) {
      pushMatrix();  
      rotateZ(i*TWO_PI/haloTurns + j*TWO_PI/haloPoints/haloTurns+3*PI/6- frameCount*PI/120);
      translate(Rd *5, 0, 0);
      rotateY(j*TWO_PI/haloPoints+frameCount*PI/60f);
      translate(Rd*1.6, 0, 0);
...
class Sprinkles {
  ...
  PVector pos = new PVector(random(Rd-rd/1.5, Rd+rd/1.5), random(2*PI), random(2*PI));
  color col;
